        ...
        <>
            <div className='container'>
                <div className='row mt-5 p-5'>
                    <div className='col text-center text-muted p-3'>
                        <h1 className='fs-1'>
                ...
                <div className='row mt-5 border-top p-5'>
                    <div className='col mt-5 p-5 fs-5'>
                        <p>
                    ...
                    <div className='col  mt-5 p-5 fs-5'>
                        ...
                        <p>And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is <a href='#'> saying about us.</a> </p>
                    </div>
                </div>
            </div>
        </>
